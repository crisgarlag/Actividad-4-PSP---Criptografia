...
import actividad4.criptografia.persistencia.EncriptacionSimetrica;

public class MenuEncriptacion {

	private EncriptacionSimetrica encriptacionSimetrica;

	public MenuEncriptacion() {
		this.encriptacionSimetrica = new EncriptacionSimetrica();
		encriptacionSimetrica.inicializarVariables();
	}
	...
	public String menu() {
		...
		try {
			...
			case "2":
				...
				mensaje = sc.nextLine();
				encriptacionSimetrica.encriptarMensaje(mensaje);
				;
				break;
			case "3":
				encriptacionSimetrica.mostrarMensajeEncriptado();
				break;
			case "4":
				encriptacionSimetrica.desencriptarMensaje();
				break;
			...
			case "5":
				...
				encriptacionSimetrica.encriptarCoche(coche);
				;
				break;
			default:
